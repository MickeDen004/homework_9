...
def file_function(*my_list: list):
    lines = my_list
...
def shuffle_deck(deck:list, times_to_shuffle=10000):
    import random
    n = len(deck)
...
# print(func_order('Liam', 'Noah', 'Oliver', 'Ava', 'Avvva', 'Swaroop', 'Nik'))
